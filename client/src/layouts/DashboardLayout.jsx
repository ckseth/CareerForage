  ...
  return (
    <div className="min-h-screen bg-[#F7F8FC] text-slate-900 flex flex-col font-sans">
      ...
      <div className="flex flex-1 relative overflow-hidden">
        ...
        <aside
          className={`fixed lg:static inset-y-0 left-0 z-50 w-64 bg-white border-r border-slate-200 flex flex-col justify-between transform transition-transform duration-300 ${
        ...
        >
          <div>
            ...
            {/* User Role Banner */}
            <div className="px-4 py-3 mx-4 mt-4 bg-slate-50 rounded-2xl border border-slate-200 flex items-center justify-between">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          <header className="h-20 bg-white/90 border-b border-slate-200 sticky top-0 z-30 backdrop-blur-md px-4 sm:px-8 flex items-center justify-between">
            ...
            <div className="flex items-center gap-4 ml-auto">
              ...
              <div className="relative">
                <button
                  ...
                  className="w-10 h-10 rounded-xl bg-slate-50 border border-slate-200 flex items-center justify-center text-slate-600 hover:text-slate-900 relative transition-colors"
                >
                ...
                <AnimatePresence>
                  {notificationsOpen && (
                    <motion.div
                      ...
                      exit={{ opacity: 0, y: 10 }}
                      className="absolute right-0 mt-2 w-80 bg-white border border-slate-200 rounded-2xl shadow-xl py-3 z-50 text-xs"
                    >
                      <div className="px-4 pb-2 border-b border-slate-100 flex items-center justify-between">
                        <span className="font-bold text-slate-900">Notifications</span>
                        <span className="text-[10px] font-semibold px-2 py-0.5 rounded-full bg-indigo-50 text-indigo-600">2 New</span>
                      </div>
                      <div className="divide-y divide-slate-100 max-h-64 overflow-y-auto">
                        <div className="p-3.5 hover:bg-slate-50 transition-colors cursor-pointer">
                          <p className="font-semibold text-slate-900 text-xs">Application Status Updated</p>
                          <p className="text-[11px] text-slate-500 mt-0.5">Your application for Senior React Engineer has been Shortlisted.</p>
                          <span className="text-[9px] text-slate-400 mt-1 block">10 mins ago</span>
                        </div>
                        <div className="p-3.5 hover:bg-slate-50 transition-colors cursor-pointer">
                          <p className="font-semibold text-slate-900 text-xs">ATS Resume Analyzed</p>
                          <p className="text-[11px] text-slate-500 mt-0.5">Your ATS Resume score improved to 94/100.</p>
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-2 py-1.5 px-3 rounded-xl bg-slate-50 border border-slate-200 hover:border-slate-300 transition-all"
                >
                  ...
                  <div className="text-left hidden md:block">
                    <p className="text-xs font-bold text-slate-900 leading-none">{user?.name || 'Account'}</p>
                    <p className="text-[10px] text-slate-500 capitalize font-medium">{user?.role || 'User'}</p>
                  </div>
                  ...
                  {profileDropdownOpen && (
                    ...
                    >
                      ...
                      <div className="py-1">
                        ...
                        >
                          <UserCheck className="w-3.5 h-3.5 text-slate-400" /> Profile & Skills
                        </button>
                        <button
                          onClick={() => {
                            setProfileDropdownOpen(false);
          ...
          {/* Main Dashboard Child Page Content */}
